...
/**
 * A proxy that acts like the server for the client. It contains all of the 
 * functions that can be called on the server. Each function calls the Client Communicator to complete the request. 
 * @author Doug
 * 
 */
