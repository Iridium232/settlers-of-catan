...
public class FascadeTest {
	...
	public void testCanBuildRoad() 
	{
		...
		assertFalse(facade.canBuildRoad(inactive_player, this.desertN, false, false));
		
		//Should be false because he cannot afford it
		assertFalse(facade.canBuildRoad(active_player, this.desertN, false, false));
		...
		assertFalse(facade.canBuildRoad(active_player, desertNW, false, false));
		
		//Should be true because he can afford it, it is his turn, and there are adjoining pieces
		assertTrue(facade.canBuildRoad(active_player, desertN, false, false));
		
		//Should be false because there is already a road there
		assertFalse(facade.canBuildRoad(active_player, desertNE, false, false));
